...
public class SSEntityScriptedSurvivor extends EntityCreature {
    ...
    protected void fall(float f) {
        super.fall((float) (f * (0.42D / mod_ScriptedSurvivors.scripts.get(type).jumpHeight)));
    }
    ...
    public void onUpdate() {
        ...
        if ((idleStatementDelay++ >= 400 && rand.nextInt(250) == 0) || idleStatementDelay > 715) {
            ...
            this.worldObj.getClosestPlayerToEntity(this, 16D).addChatMessage(new ChatComponentText(s));
        }
    ...
    @Override
    public void damageEntity(DamageSource d, float i) {
        int j = 25 - pack.getTotalArmorValue();
        float k = i * j + damageRemainder;
        pack.damageArmor(i);
        i = k / 25;
