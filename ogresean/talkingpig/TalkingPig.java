    ...
    public void onPlayerAttack(LivingHurtEvent event) {
        if (event.entityLiving instanceof EntityAnimal) {
            ...
            if (source instanceof EntityPlayer && !source.getEntityData().getBoolean("TalkingPigDead")) {
                @SuppressWarnings("unchecked") List<EntityTalkingPig> entities = source.worldObj.getEntitiesWithinAABB(EntityTalkingPig.class, source.boundingBox.expand(10.0, 3.0, 10.0));
